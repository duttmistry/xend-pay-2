...
@Component({
  selector: 'app-confirm-shareholders-verify-manual',
  templateUrl: './confirm-shareholders-verify-manual.component.html',
  styleUrls: ['./confirm-shareholders-verify-manual.component.scss']
})
export class ConfirmShareholdersVerifyManualComponent {
  loggedInUser = 1;
  isAutoFlow = true;
